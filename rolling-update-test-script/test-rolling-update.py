...
old_code_response = "Hello World. <br/>This is Gaurav Sharma Udacity Devops-nanodegree capstone project"
new_code_response = "This is Gaurav Sharma Udacity Devops-nanodegree capstone project"
response_texts = []
for i in range(600):
